...
function fetchWeather(latitude, longitude) {
  var URL = 'http://api.openweathermap.org/data/2.5/weather?units=metric&lat=' + latitude + '&lon=' + longitude + '&APPID=ca3749d90ce5fb91677d2a7b3c5620ce'
  
  $.ajax({
    type: 'GET',
    url: URL,
    success: function(response) {
      $('#weather').append('Current temperature is ' + response.main.temp + '&deg;C')
    }
  })
}
